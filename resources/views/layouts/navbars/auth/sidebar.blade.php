    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link {{ (Request::is('employees') ? 'active' : '') }}" href="{{ url('employees') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('employees') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
        ...
        <li class="nav-item mt-2">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Operator Feature</h6>
        </li>
        @endcan
        @can('tour-package-list')
        <li class="nav-item">
            <a class="nav-link {{ (Request::is('package-tour') ? 'active' : '') }}" href="{{ url('package-tour') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @endcan
        @can('list-package-list')
        <li class="nav-item">
            <a class="nav-link {{ (Request::is('Package-list') ? 'active' : '') }}" href="{{ url('Package-list') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
